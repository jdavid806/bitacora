...
class Estimates extends Security_Controller
{
    ...
    function update_estimate_status($estimate_id, $status, $is_modal = false)
    {
        ...
        if ($this->login_user->user_type == "client") {
            ...
            $this->get_send_estimate_client_ext_template_wpp($estimate_id);
    ...
    function get_send_estimate_client_ext_template_wpp($estimate_id)
    {
        ...
        $content = str_replace('{ESTIMATE_URL}', "<p>$url/sistema/index.php/public_routes/no_auth_preview/{$estimate_info->id}/{$estimate_info->public_key}</p>", $content);
    ...
    function send_estimate()
    {
        ...
        $notification_setting_info = $this->Notification_settings_model->get_notify_to_users_of_event("estimate_accepted");
