...
class Settings extends Security_Controller
{
    ...
    function invoices()
    {
        ...
        $templates = $this->Templates_model->get_details(["template_type" => "invoice_footer"])->getResult();
    ...
    function save_notification_settings()
    {
        ...
        $data = array(
            ...
            "enable_whatsapp" => $this->request->getPost("enable_whatsapp"),
    ...
    function authorized_users()
    {
        ...
        return $this->template->rander("settings/authorized_users", $view_data);
    }

    function save_authorized_user_settings()
    {
        $settings = array("can_approve_budget_users");
