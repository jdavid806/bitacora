...
if (!function_exists('translateCallStatus')) {
    function translateCallStatus($status) {
        return app_lang('twilio_call_status_'.$status) ?? app_lang('unknown');
    }
}

if (!function_exists('get_twilio_call_details')) {
    function get_twilio_call_details($call_sid) {
        
        $client = new Client("AC6b0e817ff1ce14e92db315b18ce3ea11", '6d52c1c30524df76d126d952979e3af2');
        ...
        try {
            ...
            log_message('error', 'Error al obtener detalles de la llamada de Twilio: ' . $e->getMessage());
            return null;
        }
    }
}
