...
class Project_comments_model extends Crud_model
{
    ...
    function get_details_by_columns($options = array())
    {
        ...
        $sql = "SELECT $project_comments_table.id,$project_comments_table.project_id, $project_comments_table.task_id, $project_comments_table.description, $project_comments_table.deleted,$project_comments_table.created_by, $project_comments_table.id AS parent_commment_id, CONCAT($users_table.first_name, ' ',$users_table.last_name) AS created_by_user, $users_table.image as created_by_avatar, $users_table.user_type,
     ...
     function get_details_refactor($options = array())
    {
        ...
        $sql = "SELECT $project_comments_table.id AS parent_commment_id, CONCAT($users_table.first_name, ' ',$users_table.last_name) AS created_by_user, $users_table.user_type, $project_comments_table.description, $project_comments_table.created_at AS created_at, $project_comments_table.files AS files
            $extra_select
        FROM $project_comments_table
        LEFT JOIN $users_table ON $users_table.id= $project_comments_table.created_by
        WHERE $project_comments_table.deleted=0 $where
