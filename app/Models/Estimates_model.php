...
class Estimates_model extends Crud_model
{
    ...
    function get_details($options = array())
    {
        ...
        $sql = "SELECT $estimates_table.*, $clients_table.currency, $clients_table.currency_symbol, $clients_table.company_name, $projects_table.title as project_title, $clients_table.is_lead, $clients_table.phone, $clients_table.email, $clients_table.especialidad, $clients_table.city,
           CONCAT($users_table.first_name, ' ',$users_table.last_name) AS signer_name, CONCAT(user_creator.first_name, ' ', user_creator.last_name) AS user_creator_name, $users_table.email AS signer_email,
        ...
        LEFT JOIN $users_table AS user_creator ON user_creator.id= $estimates_table.accepted_by
