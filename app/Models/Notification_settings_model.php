...
class Notification_settings_model extends Crud_model
{
    ...
    function notify_to_terms()
    {
        return array(
            ...
            "task_collaborators",
            "comment_creator",
            "cusomer_feedback_creator",
            "leave_applicant",
            "ticket_creator",
            "ticket_assignee",
            "estimate_request_assignee",
            "recipient",
            "mentioned_members",
            "owner",
            "client_assigned_contacts",
            "post_creator",
            "order_creator_contact",
            "estimate_creator",
            "proposal_creator"
        );
    }
    ...
    function get_notify_to_users_of_event($event = "")
    {
        ...
        if ($event) {
            ...
            $result->enable_whatsapp = $notification_settings->enable_whatsapp;
            $result->enable_email = $notification_settings->enable_email;
