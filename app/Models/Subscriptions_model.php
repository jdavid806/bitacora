...
class Subscriptions_model extends Crud_model
{
    ...
    function get_details($options = array())
    {
        ...
        $sql = "SELECT $subscriptions_table.*, $clients_table.currency, $clients_table.currency_symbol, $clients_table.company_name, $clients_table.phone, $clients_table.email, $clients_table.is_lead, IFNULL(NULLIF($clients_table.cod_cliente, ''), 'sin código') AS cod_cliente,
