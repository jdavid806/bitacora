...
class Ticket_comments_model extends Crud_model
{
    ...
    function get_details_by_columns($options = array())
    {
        ...
        $sql = "SELECT $ticket_comments_table.id, $ticket_comments_table.ticket_id, $ticket_comments_table.created_by, $ticket_comments_table.deleted, $ticket_comments_table.created_at,$ticket_comments_table.description, CONCAT($users_table.first_name, ' ',$users_table.last_name) AS created_by_user, $users_table.image as created_by_avatar, $users_table.user_type, $tickets_table.creator_name, $tickets_table.creator_email
