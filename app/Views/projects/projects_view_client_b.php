...
<script>
    $(document).ready(function () {
        setTimeout(() => {
            $("a").each(function () {
                let fraccionUrl = "https://app.monaros.co/sistema/index.php/projects/view/";
                let url = $(this).attr("href");

                // Verifica que el `href` exista antes de usarlo
                if (url && url.includes(fraccionUrl)) {
                    // Si contiene fraccionUrl, no hacemos cambios
                } else {
                    // Si no contiene fraccionUrl o no tiene href, lo configuramos como "#"
                    $(this).prop("href", "#");
                }
            });
