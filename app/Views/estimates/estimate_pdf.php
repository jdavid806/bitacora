...
<table class="table-responsive" style="width: 100%;">
    ...
    <tr style="font-weight: bold; background-color: <?php echo $color; ?>; color: #bbd5e7;  ">
        <th style="width: 45%; border-right: 1px solid #eee;"> <?php echo app_lang("item"); ?> </th>
        <th style="text-align: center;  width: 20%; border-right: 1px solid #eee;"> <?php echo app_lang("quantity"); ?></th>
        <th style="text-align: right;  width: 15%; border-right: 1px solid #eee;"> <?php echo app_lang("rate"); ?></th>
    ...
    ?>
        <tr style="background-color: <?php echo $item_background ?>; ">
            ...
            <td style="text-align: center; width: 20%; border: 1px solid #fff;"> <?php echo $item->quantity . " " . $item->unit_type; ?></td>
    ...
    <tr>
        ...
        <td style="text-align: right; width: 20%; background-color: <?php echo $color; ?>; color: #bbd5e7;">
            <b><?php echo to_currency($estimate_total_summary->estimate_total, $estimate_total_summary->currency_symbol); ?></b>
        </td>
    </tr>
</table>
...
<div>
    <?= htmlspecialchars_decode(get_setting("estimate_footer")); ?>
</div>