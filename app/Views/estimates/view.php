                        ...
                        <div class="title-button-group mr0">
                            <span class="dropdown inline-block mt15">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <?php if (logged_user_can_approve_budget()) { ?>
                                        <?php
                                    ...
                                    if ($estimate_status == "draft" || $estimate_status == "sent") {
                                    ?>
                                        <li role="presentation"><?php echo ajax_anchor(get_uri("estimate/send_estimate_client_authorization_template_wpp/" . $estimate_info->id), "<i data-feather='send' class='icon-16'></i> " . app_lang('send_for_authorization'), array("title" => app_lang('send_for_authorization'), "data-post-id" => $estimate_info->id, "role" => "menuitem", "tabindex" => "-1", "class" => "dropdown-item")); ?> </li>
                                        <?php
