...
$settings_menu = array(
    "app_settings" => array(
        ...
        array("name" => "whatsapp_templates", "url" => "templates"),
        array("name" => "templates", "url" => "footer_templates"),
        array("name" => "authorized_users", "url" => "settings/authorized_users"),
        ...
        array("name" => "assignment_panel", "url" => "tickets_settings/settings_assign_tickets_automatic"),
    ),
