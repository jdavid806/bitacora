                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-8 col-md-8">
                                        <label for="invoice_footer" class=" col-md-8"><?php echo app_lang('invoice_footer'); ?></label>
                                        <div class="">
                                            <?php
            ...
            if (templateId) {
                $.ajax({
                    ...
                    success: function(response) {
                        if (typeof tinymce !== 'undefined' && tinymce.get('invoice_footer')) {
                            console.log(response.content);
                            tinymce.get('invoice_footer').setContent(response.content);
                        } else {
                            $('#invoice_footer').val(response.content);
                        }
                    },
