...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="enable_whatsapp" class="col-md-3"><?php echo app_lang('whatsapp'); ?></label>
                <div class="col-md-9">
                    <?php
                    echo form_checkbox("enable_whatsapp", "1", $model_info->enable_whatsapp ? true : false, "id='enable_whatsapp' class='form-check-input'");
                    ?>
                </div>
            </div>
        </div>
