...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#stripe_product').select2({
            data: <?php echo json_encode($stripe_products_dropdown); ?>
        }).on("change", function() {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $('#stripe_product_price_id').select2({
                            data: result.stripe_product_prices_dropdown
                        });
                        appLoader.hide();
                    }
                });
        ...
        $('#stripe_product_price_id').select2({
            data: <?php echo json_encode($stripe_product_prices_dropdown); ?>
        });
    });
</script>