...
<div id="page-content" class="page-wrapper clearfix">
    ...
    <ul id="client-contact-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs b-b rounded-0 border-top-0" role="tablist">
        ...
        <?php if ($login_user->user_type == 'client') { ?>
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("clients/licenses_services/" . $user_info->id); ?>" data-bs-target="#tab-my-items"> <?php echo app_lang('items'); ?></a></li>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-my-items"></div>
