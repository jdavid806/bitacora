...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#invoice-table").appTable({
            ...
            printColumns: combineCustomFieldsColumns([1, 3, 4, 5, 7, 8, 9, 10, 11], '<?php echo $custom_field_headers; ?>'),
            xlsColumns: combineCustomFieldsColumns([1, 3, 5, 4, 7, 8, 9, 10, 11], '<?php echo $custom_field_headers; ?>'),
            summation: [{
                    column: 8,
                    dataType: 'currency',
