    ...
    <div class="clearfix">
        ...
        <div class="row clients-view-button">
            ...
            <div class="col-md-12">
                ...
                <div class="page-title clearfix no-border no-border-top-radius no-bg">
                    ...
                    <h1 class="pl0">
                        ...
                        <?php if ($client_info->lead_status_id) { ?>
                            ...
                            <span data-bs-toggle="tooltip" data-bs-html="true" title="<?php echo $lead_information; ?>"><i
                ...
                <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs border-bottom-0"
                    role="tablist">

                    <li><a role="presentation" data-bs-toggle="tab"
                            href="<?php echo_uri("clients/contacts/" . $client_info->id); ?>"
                            data-bs-target="#client-contacts"> <?php echo app_lang('contacts'); ?></a></li>

                    <li><a role="presentation" data-bs-toggle="tab"
                            href="<?php echo_uri("clients/company_info_tab/" . $client_info->id); ?>"
                            data-bs-target="#client-info"> <?php echo app_lang('client_info'); ?></a></li>
                    ...
                    <li><a role="presentation" data-bs-toggle="tab"
                            href="<?php echo_uri("clients/tasks/" . $client_info->id); ?>"
                            data-bs-target="#client-tasks"><?php echo app_lang('tasks'); ?></a></li>
                    ...
                    <?php if ($show_invoice_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/invoices/" . $client_info->id); ?>"
                                data-bs-target="#client-invoices"> <?php echo app_lang('invoices'); ?></a></li>

                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/payments/" . $client_info->id); ?>"
                                data-bs-target="#client-payments"> <?php echo app_lang('payments'); ?></a></li>
                    ...
                    <?php if ($show_estimate_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/estimates/" . $client_info->id); ?>"
                                data-bs-target="#client-estimates"> <?php echo app_lang('estimates'); ?></a></li>
                    ...
                    <?php if ($show_estimate_request_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/estimate_requests/" . $client_info->id); ?>"
                                data-bs-target="#client-estimate-requests"> <?php echo app_lang('estimate_requests'); ?></a>
                        </li>
                    ...
                    <?php if ($show_order_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/orders/" . $client_info->id); ?>"
                                data-bs-target="#client-orders"> <?php echo app_lang('orders'); ?></a></li>
                    ...
                    <?php if ($show_contract_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/contracts/" . $client_info->id); ?>"
                                data-bs-target="#client-contracts"> <?php echo app_lang('contracts'); ?></a></li>
                    ...
                    <?php if ($show_proposal_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/proposals/" . $client_info->id); ?>"
                                data-bs-target="#client-proposals"> <?php echo app_lang('proposals'); ?></a></li>
                    ...
                    <li><a role="presentation" data-bs-toggle="tab"
                            href="<?php echo_uri("clients/files/" . $client_info->id . "/" . $files_tab . "/" . $folder_id); ?>"
                    ...
                    <?php if ($show_event_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/events/" . $client_info->id); ?>"
                                data-bs-target="#client-events"> <?php echo app_lang('events'); ?></a></li>
                    ...
                    <?php if ($show_expense_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/expenses/" . $client_info->id); ?>"
                                data-bs-target="#client-expenses"> <?php echo app_lang('expenses'); ?></a></li>
                    ...
                    <?php if ($show_subscription_info) { ?>
                        ...
                        <li><a role="presentation" data-bs-toggle="tab"
                                href="<?php echo_uri("clients/subscriptions/" . $client_info->id); ?>"
                                data-bs-target="#client-subscriptions"> <?php echo app_lang('subscriptions'); ?></a></li>

                    <?php } ?>

                    <li><a role="presentation" data-bs-toggle="tab"
                            href="<?php echo_uri("clients/serviciosActivos/" . $client_info->id); ?>"
                            data-bs-target="#client-serviciosA"> <?php echo app_lang('dataLic'); ?></a></li>

                    <li><a role="presentation" data-bs-toggle="tab"
                            href="<?php echo_uri("mailbox/clientEmails/" . $client_info->id . "/client"); ?>"
                            data-bs-target="#mailbox_client_emails"> <?php echo app_lang('email'); ?></a></li>


                    <li><a role="presentation" data-bs-toggle="tab"
                            href="<?php echo_uri("leads/messages/" . $client_info->id); ?>"
                            data-bs-target="#lead-send-messages"><?php echo app_lang('send_messages'); ?></a></li>
                    <li><a role="presentation" data-bs-toggle="tab"
                            href="<?php echo_uri("leads/make_calls/" . $client_info->id); ?>"
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="client-serviciosA"></div>
