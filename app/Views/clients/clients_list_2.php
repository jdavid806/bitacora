...
<?php echo_uri("clients/list_data") ?>
    ...
    $(selector).appTable({
        ...
        <?php echo $custom_field_filters; ?>
            ...
            columns: [
                ...
                {title: "<?php echo app_lang("cod_cliente") ?>", order_by: "cod_cliente"},
                ...
                // {title: '<I data-feather="phone-forwarded" class="icon-16"></I>', "class": "text-center option w100", visible: "FLKDFS"}
            ],
