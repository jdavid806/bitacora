<?php echo form_open(get_uri("notes/save_discard"), array("id" => "note-form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    echo form_dropdown("title", $titulos, array($model_info->title), "class='select2'");
                    ?>
                    <?php
                    /*
                ...
                <?php } else { ?>
                    <div class="form-group">
                        <label for="mark_as_public" class=" col-md-12">
                            ...
                            <span id="mark_as_public_help_message" class="ml10 hide"><i data-feather="alert-triangle"
                                    class="icon-16 text-warning"></i>
                                <?php echo app_lang("mark_as_public_help_message"); ?></span>
                        </label>
                    </div>
                <?php } ?>
            <?php } ?>
