                ...
                <div class="row">
                    ...
                    <div class="d-flex m0">
                        <div class="flex-shrink-0">
                            <span class="avatar avatar-sm">
                                <img id="task-assigned-to-avatar"
                                    src="<?php echo get_avatar($model_info->assigned_to_avatar); ?>" alt="..." />
                            </span>
                        </div>
                        <div class="w-100 ps-2 pt5">
                            ...
                            <p>
                                <span class='badge badge-light mr5'
                    ...
                    <?php if ($total_sub_tasks) { ?>
                        <div class="col-md-12 mb15 mt15">
                            <span class=""><?php echo $completed_sub_tasks . "/" . $total_sub_tasks; ?>
                                <?php echo app_lang("sub_tasks_completed"); ?></span>
                    ...
                    <?php if ($model_info->project_id) { ?>
                        <div class="col-md-12 mb15 mt15">
                            <strong><?php echo app_lang('milestone') . ": "; ?></strong>
                            <?php echo get_update_task_info_anchor_data($model_info, "milestone", $can_edit_tasks); ?>
                        </div>
                    <?php } ?>

                    <div class="col-md-12 mb15 <?php echo $model_info->project_id ? "" : "mt15"; ?>">
                        <strong><?php echo app_lang('start_date') . ": "; ?></strong>
                        <?php echo get_update_task_info_anchor_data($model_info, "start_date", $can_edit_tasks); ?>
                        <?php
                    ...
                    <div class="col-md-12 mb15">
                        ...
                        <?php if ($model_info->deadline_milestone_title) { ?>
                            <span class="help task-deadline-milestone-tooltip" data-bs-toggle="tooltip"
                                title="<?php echo app_lang('milestone') . ": " . $model_info->deadline_milestone_title; ?>"><i
                                    data-feather="help-circle" class="icon-16"></i></span>
                        <?php } ?>
                    </div>
                    ...
                    <?php if ($model_info->ticket_id && $model_info->project_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang("ticket") . ": "; ?> </strong>
                            <?php echo anchor(get_uri("tickets/view/" . $model_info->ticket_id), get_ticket_id($model_info->ticket_id) . " - " . $model_info->ticket_title); ?>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($model_info->recurring) { ?>
                        ...
                        <div class="col-md-12 mb15">
                            ...
                            <?php echo $model_info->repeat_every . " " . app_lang("interval_" . $model_info->repeat_type); ?>
                        </div>

                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang("cycles") . ": "; ?> </strong> <span
                                class="<?php echo $recurring_cycle_class; ?>"><?php echo $cycles; ?></span>
                        </div>

                        <?php if (!$recurring_stopped && (int) $model_info->next_recurring_date) { ?>
                            <div class="col-md-12 mb15">
                                <strong><?php echo app_lang("next_recurring_date") . ": "; ?> </strong>
                                <?php echo format_to_date($model_info->next_recurring_date, false); ?>
                            </div>
                        <?php } ?>

                    <?php } ?>

                    <?php if (in_array($model_info->context, ["project", "ticket", "general"])) { ?>
                        <div class="col-md-12 mb15">
                            <?php
                            if ($show_timer) {
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php if ($model_info->lead_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('lead') . ": "; ?> </strong>
                            <?php echo anchor(get_uri("leads/view/" . $model_info->lead_id), $model_info->company_name); ?>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($model_info->invoice_id) { ?>
                        <div class="col-md-12 mb15">
                            ...
                            <?php echo anchor(get_uri("invoices/view/" . $model_info->invoice_id), $model_info->invoice_display_id); ?>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($model_info->estimate_id) { ?>
                        <div class="col-md-12 mb15">
                            ...
                            <?php echo anchor(get_uri("estimates/view/" . $model_info->estimate_id), get_estimate_id($model_info->estimate_id)); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->order_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('order') . ": "; ?> </strong>
                            <?php echo anchor(get_uri("orders/view/" . $model_info->order_id), get_order_id($model_info->order_id)); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->contract_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('contract') . ": "; ?> </strong>
                            <?php echo anchor(get_uri("contracts/view/" . $model_info->contract_id), $model_info->contract_title); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->proposal_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('proposal') . ": "; ?> </strong>
                            <?php echo anchor(get_uri("proposals/view/" . $model_info->proposal_id), get_proposal_id($model_info->proposal_id)); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->subscription_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('subscription') . ": "; ?> </strong>
                            <?php echo anchor(get_uri("subscriptions/view/" . $model_info->subscription_id), $model_info->subscription_title); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->expense_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('expense') . ": "; ?> </strong>
                            <?php echo modal_anchor(get_uri("expenses/expense_details"), ($model_info->expense_title ? $model_info->expense_title : format_to_date($model_info->expense_date, false)), array("title" => app_lang("expense_details"), "data-post-id" => $model_info->expense_id, "data-modal-lg" => "1")); ?>
                        </div>
                    <?php } ?>
                        ...
                        foreach ($custom_fields_list as $data) {
                            if ($data->value) {
                                ...
                                <div class="col-md-12 mb15 text-break">
                                    ...
                                    <?php echo view("custom_fields/output_" . $data->field_type, array("value" => $data->value)); ?>
                                </div>
                                <?php
                            }
                        }
                    ...
                    <div class="col-md-12 mb15 b-t">
                        <div class="pb10 pt10">
                            <strong class="float-start mr10"><?php echo app_lang("checklist"); ?></strong><span
                                class="chcklists_status_count">0</span><span>/</span><span
                                class="chcklists_count"></span>
                        </div>
                        ...
                        <?php if ($can_edit_tasks) { ?>
                            <div class="mb5 mt5 btn-group checklist-options-panel hide" role="group">
                                <button id="type-new-item-button" type="button"
                                    class="btn btn-default checklist_button active">
                                    <?php echo app_lang('type_new_item'); ?></button>
                                <button id="select-from-template-button" type="button"
                                    class="btn btn-default checklist_button">
                                    <?php echo app_lang('select_from_template'); ?></button>
                                <button id="select-from-checklist-group-button" type="button"
                                    class="btn btn-default checklist_button">
                                    <?php echo app_lang('select_from_checklist_group'); ?></button>
                            </div>
                            ...
                            <div class="mb10 p0 checklist-options-panel hide">
                                <button type="submit" class="btn btn-primary"><span data-feather="check-circle"
                                        class="icon-16"></span> <?php echo app_lang('add'); ?></button>
                                <button id="checklist-options-panel-close" type="button" class="btn btn-default ms-2"><span
                                        data-feather="x" class="icon-16"></span> <?php echo app_lang('cancel'); ?></button>
                            </div>
                        <?php } ?>
                    </div>
                    <?php echo form_close(); ?>
                    ...
                    <div class="col-md-12 mb15 b-t">
                        ...
                        foreach ($contexts as $context) {
                            ...
                            ?>
                            <input type="hidden" name="<?php echo $context_id_key; ?>"
                                value="<?php echo $model_info->$context_id_key; ?>" />
                        <?php } ?>
                        ...
                        <?php if ($can_create_tasks) { ?>
                            ...
                            <div id="sub-task-options-panel" class="col-md-12 mb15 p0 hide">
                                <button type="submit" class="btn btn-primary"><span data-feather="check-circle"
                                        class="icon-16"></span> <?php echo app_lang('create'); ?></button>
                    ...
                    <?php if ($can_edit_tasks && $model_info->context !== "general") { ?>
                        <div class="col-md-12 mb15">
                            <span class="dropdown">
                                <button class="btn btn-default dropdown-toggle btn-border" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="true">
                                    <i data-feather="shuffle" class="icon-16"></i> <?php echo app_lang('add_dependency'); ?>
                                </button>
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation">
                                        <?php echo js_anchor(app_lang("this_task_blocked_by"), array("class" => "add-dependency-btn dropdown-item", "data-dependency_type" => "blocked_by")); ?>
                                    </li>
                                    <li role="presentation">
                                        <?php echo js_anchor(app_lang("this_task_blocking"), array("class" => "add-dependency-btn dropdown-item", "data-dependency_type" => "blocking")); ?>
                                    </li>
                                </ul>
                            </span>
                        </div>
                    ...
                    <div class="col-md-12 mb15 <?php echo ($blocked_by || $blocking) ? "" : "hide"; ?>"
                        id="dependency-area">
                        <div class="pb10 pt10">
                            <strong><?php echo app_lang("dependency"); ?></strong>
                        </div>

                        <div class="p10 list-group-item mb15 dependency-section <?php echo $blocked_by ? "" : "hide"; ?>"
                            id="blocked-by-area">
                            <div class="pb10"><strong><?php echo app_lang("blocked_by"); ?></strong></div>
                            <div id="blocked-by-tasks"><?php echo $blocked_by; ?></div>
                        </div>

                        <div class="p10 list-group-item mb15 dependency-section <?php echo $blocking ? "" : "hide"; ?>"
                            id="blocking-area">
                        ...
                        <div class="p0 mt10">
                            <button type="submit" class="btn btn-primary"><span data-feather="check-circle"
                                    class="icon-16"></span> <?php echo app_lang('add'); ?></button>
                            <button type="button" class="dependency-tasks-close btn btn-default"><span data-feather="x"
                                    class="icon-16"></span> <?php echo app_lang('cancel'); ?></button>
                        </div>
