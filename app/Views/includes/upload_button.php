<div class="me-auto">
    ...
    <button id="<?php echo $upload_button_id; ?>" class="btn btn-default upload-file-button float-start round"
        type="button"><i data-feather="camera" class="icon-16"></i> <span class="hidden-xs"><?php
    ...
    if ($show_recording && $https) {
        ?>
        <button type="button" id="record-start-button" class="btn btn-default record-start-btn ml10"
            style="color:#7988a2"><i data-feather="mic" class="icon-16"></i></button>
        ...
        ?>
            <span class="help" data-bs-toggle="tooltip" title="<?php echo app_lang('https_required'); ?>"><span
                    class="btn btn-default record-start-btn disabled opacity-25 ml10"><i data-feather="mic"
                        class="icon-16"></i></span></span>
