...
<?php } else { ?>
    <?php if ($invoice_info->type == "credit_note") { ?>
        <span class="invoice-info-title" style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #bbd5e7;">&nbsp;<?php echo app_lang("credit_note"); ?>&nbsp;</span><br />
        <span class="invoice-meta text-default"><?php echo app_lang("id") . ": " . $invoice_info->display_id; ?></span><br />
    <?php } else { ?>
        <span class="invoice-info-title" style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #bbd5e7;">&nbsp;<?php echo $invoice_info->display_id; ?>&nbsp;</span><br />
