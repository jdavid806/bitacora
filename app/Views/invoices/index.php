    ...
    $(document).ready(function() {
        ...
        $("#invoice-list-table").appTable({
            ...
            rangeRadioButtons: [{
                ...
                selectedOption: RangeButtonSelectedOption,
            ...
            columns: [{
                ...
                {
                    title: "<?php echo app_lang("cod_cliente") ?>",
                    "class": "w10p"
                },
                {
            ...
            printColumns: combineCustomFieldsColumns([1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12], '<?php echo $custom_field_headers; ?>'),
            xlsColumns: combineCustomFieldsColumns([1, 2, 3, 4, 5, 7, 6, 8, 9, 10, 11], '<?php echo $custom_field_headers; ?>'),
            summation: [{
                    column: 8,
                    dataType: 'currency',
