...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#recurring-invoice-table").appTable({
            ...
            rangeDatepicker: [{
                startDate: {
                    name: "next_recurring_start_date"
                },
                endDate: {
                    name: "next_recurring_end_date"
                },
            ...
            columns: [{
                ...
                {
                    title: "<?php echo app_lang("next_recurring_date") ?>",
                    "iDataSort": 4,
                    "class": "w10p"
                },
                {
            ...
            printColumns: [1, 2, 3, 4, 5, 7, 8, 9, 10],
            xlsColumns: [1, 2, 3, 4, 5, 7, 8, 9, 10],
            summation: [{
                column: 10,
                dataType: 'currency',
