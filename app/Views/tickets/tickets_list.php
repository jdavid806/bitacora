    ...
    $(document).ready(function() {
        ...
        $("#ticket-table").appTable({
            ...
            columns: [{
                ...
                {
                    title: '<?php echo app_lang("estimated_time") ?>',
                    "class": "w10p",
                },
                {
                    title: '<?php echo app_lang("tasks_in_ticket") ?>',
                    "class": "w5p",
                    order_by: "tasks_in_ticket"
                },
                {
                    visible: false,
                    searchable: false,
            ...
            printColumns: combineCustomFieldsColumns([1, 2, 3, 4, 5, 6, 7, 8, 10, 11], '<?php echo $custom_field_headers; ?>'),
            xlsColumns: combineCustomFieldsColumns([1, 2, 3, 4, 5, 6, 7, 8, 10, 11], '<?php echo $custom_field_headers; ?>')
        });
