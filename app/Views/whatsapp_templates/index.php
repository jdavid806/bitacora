                        ...
                        <ul class="nav nav-tabs vertical settings p15 d-block" role="tablist">
                            ...
                            <?php
                                ...
                                foreach ($value as $sub_template_name => $sub_template) {
                                    echo "<span class='whatsapp-template-row list-group-item clickable' data-name='$sub_template_name' data-template-language=''>" . app_lang($sub_template_name) . "</span>";
                                }
