<div class="card">
    ...
    <?php echo form_open(get_uri("templates/save"), array("id" => "whatsapp-template-form-$model_info->id", "class" => "general-form whatsapp-template-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        var formId = "#whatsapp-template-form-<?php echo $model_info->id; ?>";
        $(formId).appForm({
            isModal: false,
