        ...
        <div class="container-fluid">
            ...
            <div class="clearfix form-group">
                <div class="row align-items-center">
                    <label for="start_time" class=" col-md-3 col-sm-3"><?php echo app_lang('start_time'); ?></label>
                    ...
                    <label for="end_time" class=" col-md-3 col-sm-3"><?php echo app_lang('end_time'); ?></label>
                    <div class=" col-md-3 col-sm-3">
                        <?php
