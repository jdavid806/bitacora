...
class Whiteboards_Updates extends Security_Controller {
    ...
    function index() {
        ...
        echo $this->template->view("Whiteboards\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_whiteboards_setting("whiteboards_item_purchase_code");
