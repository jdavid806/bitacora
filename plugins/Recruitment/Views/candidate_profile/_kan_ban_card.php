  ...
  <div class="panel-body">
    <div class="row">
      <div class="col-md-12 task-name">
        ...
        <a href="<?php echo site_url('recruitment/candidate/' . $candidate['id']); ?>" >
     ...
     <div class="col-md-10 text-left text-muted">
        ...
        <span class="mright5 inline-block text-muted" data-toggle="tooltip" >
          ...
          $datas = '';
          if (isset($cp)) {
            $datas = '<a href="' . site_url('recruitment/recruitment_campaign/' . $cp->cp_id) . '">' . $cp->campaign_code . ' - ' . $cp->campaign_name . '</a>';
          }
    ...
    <?php if($candidate['status'] == 6){ ?>
     <?php if (re_has_permission("recruitment_can_edit") || is_admin()) { ?>
       <div class="col-md-12 mtop2">
        <span class="mright5 inline-block text-muted" data-toggle="tooltip" >
         <a href="<?php echo site_url('recruitment/transfer_to_hr/' . $candidate['id'] ); ?>" class="btn btn-success btn-xs"><?php echo app_lang('tranfer_personnels') ?></a>
        </span>
       </div>
     <?php } ?>
