...
<link href="<?php echo base_url('plugins/Recruitment/assets/css/export_candidate_pdf.css') . '?v='.RE_REVISION ; ?>"  rel="stylesheet" type="text/css" />
	...
	<tbody>
		<tr>
			<td width="27%"  class="text_align_center candidate_name_widt_27">
				<h3 class="text_align_center  candidate_name_color"><?php echo html_entity_decode($candidate['candidate_name'].' '.$candidate['last_name']) ?></h3><br>
			...
			<td width="73%" class="align_right logo_with" >
				<?php
	...
	<tbody>
		<tr>
			<td width="30%"  class="align_left avatar_width_30">
				...
				$no_image_file_path = '/plugins/Recruitment/Uploads/none_avatar.jpg';
				if(isset($cadidate_avatar) && $cadidate_avatar != ''){
					$file_path = '/plugins/Recruitment/Uploads/candidate/avartar/'.$cadidate_avatar['rel_id'] . '/' . $cadidate_avatar['file_name'];
					?>
					<img class="avartar_w_h" src="<?php echo html_entity_decode($file_path) ;?>" alt="<?php echo html_entity_decode($cadidate_avatar['file_name']) ?>" >

				<?php }else{?> 
					<img class="avartar_w_h" src="<?php echo html_entity_decode($no_image_file_path); ?>" alt="nul_image.jpg">
			...
			<td width="70%" class="align_left text_align_justify qualifications_width_70" >
				<h4 class="card-title  bold summary_title"><?php echo app_lang('summary_of_qualifications') ?></h4>

				<p class="introduce_yourself"><?php echo html_entity_decode($candidate['introduce_yourself']) ?></p><br>

				<h4 class="card-title  bold summary_title"><?php echo app_lang('skill_title') ?></h4>
...
<h4 class="card-title  bold employment_record_title"><?php echo app_lang('employment_record') ?></h4>
				...
				<tbody>
					...
					<tr>
						...
						<td width="15%"  class="align_left td_width_15" >
							<span class="record_title"><?php echo app_lang('from_date') ?></span><br><br>
							<span class="record_content"><?php echo html_entity_decode(format_to_date($candidate_experience['from_date'])) ?></span>
						</td>
						<td width="15%"  class="align_left td_width_15">
							<span class="record_title"><?php echo app_lang('to_date') ?></span><br><br>
							<span class="record_content"><?php echo html_entity_decode(format_to_date($candidate_experience['to_date'])) ?></span>
						</td>
						<td width="38%"  class="align_left td_width_38">
							<span class="record_title"><?php echo app_lang('company') ?></span><br><br>
						...
						<td width="27%"  class="align_left td_width_27">
							<span class="record_title"><?php echo app_lang('position') ?></span><br><br>
					...
					<tr>
						...
						<td width="96%"  class="text_align_justify td_width_96">
							<span class="record_title"><?php echo app_lang('job_description') ?>: </span>
...
<h4 class="card-title  bold employment_literacy_title"><?php echo app_lang('employment_literacy') ?></h4>
			...
			<table class="table border_table">
				<tbody>
					...
					<tr>
						...
						<td width="15%"  class="align_left td_width_15">
							<span class="literacy_title"><?php echo app_lang('from_date') ?></span><br><br>
							<span class="literacy_content"><?php echo html_entity_decode(format_to_date($literacy['literacy_from_date'])) ?></span>
						</td>
						<td width="15%"  class="align_left td_width_15">
							<span class="literacy_title"><?php echo app_lang('to_date') ?></span><br><br>
							<span class="literacy_content"><?php echo html_entity_decode(format_to_date($literacy['literacy_to_date'])) ?></span>
						</td>
						...
						<td width="27%"  class="align_left td_width_27">
							<span class="literacy_title"><?php echo app_lang('re_degree') ?></span><br><br>
