<div class="card mb15">
    ...
    <div class="card-body p30 rounded-bottom">
        <?php echo form_open("candidate_signin/do_reset_password", array("id" => "reset-password-form", "class" => "general-form", "role" => "form")); ?>
...
<?php require 'plugins/Recruitment/assets/js/recruitment_portals/signin/new_password_form_js.php';?>
