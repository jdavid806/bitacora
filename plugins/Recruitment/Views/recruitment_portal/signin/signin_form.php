<div class="card bg-white mb15">
    ...
    <div class="card-body p30 rounded-bottom">
        <?php echo form_open("candidate_signin/authenticate", array("id" => "signin-form", "class" => "general-form", "role" => "form")); ?>
        ...
        if ($signin_validation_errors && is_array($signin_validation_errors)) {
            ...
            <div class="alert alert-danger" role="alert">
                <?php foreach ($signin_validation_errors as $validation_error) { ?>
                    ...
                    <?php echo html_entity_decode($validation_error); ?>
                    <br />
                <?php } ?>
            </div>
        <?php } ?>
        ...
        if (isset($redirect)) {
            echo html_entity_decode($redirect);
        }
        ?>" />
        ...
        <?php echo form_close(); ?>
        <div class="mt5"><?php echo anchor("candidate_signin/request_reset_password", app_lang("forgot_password")); ?></div>

        <?php if (!get_setting("disable_client_signup")) { ?>
            <div class="mt20"><?php echo app_lang("you_dont_have_an_account") ?> &nbsp; <?php echo anchor("candidate_signup", app_lang("signup")); ?></div>
        <?php } ?>
...
<?php require 'plugins/Recruitment/assets/js/recruitment_portals/signin/signin_form_js.php';?>
