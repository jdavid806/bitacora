...
<script type="text/javascript">
    ...
    AppHelper.userId = "<?php echo html_entity_decode($user_id); ?>";
    ...
    AppHelper.settings.userEnableWebNotification = "<?php echo html_entity_decode($enable_web_notification); ?>";
    ...
    AppHelper.https = "<?php echo html_entity_decode($https); ?>";
    ...
    AppHelper.csrfTokenName = "<?php echo html_entity_decode($csrf_token_name); ?>";
    AppHelper.csrfHash = "<?php echo html_entity_decode($csrf_hash); ?>";

    AppHelper.settings.defaultThemeColor = "<?php echo get_setting("default_theme_color"); ?>";

    AppHelper.settings.timepickerMinutesInterval = <?php echo html_entity_decode($timepicker_minutes_interval); ?>;
