...
<html lang="en">
    ...
    <body>
        ...
        if (get_setting("show_background_image_in_signin_page") === "yes") {
            ...
            <style type="text/css">
                html, body {
                    background-image: url('<?php echo html_entity_decode($background_url); ?>');
                ...
                <div class="form-signin">
                    <div class="card bg-white clearfix">
                        <div class="card-header text-center">
                            ...
                            <p><?php echo app_lang('Create_an_account_as_a_new_Candidate'); ?></p>
                        </div>
                        <div class="card-body p30 rounded-bottom">
                            <?php
                            $action_url = ($signup_type == "send_verify_email") ? "signup/send_verification_mail" : "candidate_signup/create_account";
                            ...
                            <?php } else { ?>
                                ...
                                <?php if ($signup_type === "new_client" || $signup_type === "verify_email") { ?>
                                    <div class="form-group">
                                        <label for="phonenumber" class="col-md-12"><?php echo app_lang('phonenumber'); ?></label>
                                        <div class="col-md-12">
                                            <?php
                                            echo form_input(array(
                                                "id" => "phonenumber",
                                ...
                                <?php } else if ($signup_type === "verify_email" && isset($key)) { ?>
                                    <input type="hidden" name="verify_email_key"  value="<?php echo html_entity_decode($key); ?>" />
                                <?php } ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <button class="w-100 btn btn-lg btn-primary" type="submit"><?php echo html_entity_decode($signup_type == "send_verify_email" ? app_lang("get_started") : app_lang('signup')); ?></button>
                                </div>
                            </div>
                    ...
                    <div id="signin_link"><?php echo app_lang("already_have_an_account") . " " . anchor("candidate_signin", app_lang("signin")); ?></div>
                </div>
            </div>
        </div> <!-- /container -->
        <?php require 'plugins/Recruitment/assets/js/recruitment_portals/signup/index_js.php';?>
