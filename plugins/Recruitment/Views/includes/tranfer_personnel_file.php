   ...
   <div class="modal-dialog full-screen-modal width65" role="document">
      <div class="modal-content">
            ...
            <div class="row">
               <div class="col-md-12 border-right project_file_area">
                  ...
                  <?php
                     ...
                     if(is_image($path)){ ?>
                  <img src="<?php echo base_url('modules/recruitment/uploads/set_transfer/'.$file->rel_id.'/'.$file->file_name); ?>" class="img img-responsive">
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-default" onclick="close_modal_manually('._project_file'); return false;"><?php echo app_lang('close'); ?></button>
         </div>
      </div>
      <!-- /.modal-content -->
   </div>
...
<?php require 'plugins/Recruitment/assets/js/includes/tranfer_personnel_file_js.php';?>
