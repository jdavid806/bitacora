...
function get_data_budget() {
  ...
  if($('select[name="budget"]').val() == '' || $('select[name="budget"]').val() == null){
    ...
    $('#box-loading').html(html);
      ...
      $.post(site_url + 'accounting/get_data_budget', data).done(function(response) {
...
function data_source(){
    ...
    $.post(site_url + 'accounting/check_budget', data).done(function(response) {
      response = JSON.parse(response);
...
function new_budget(){
    ...
    $.post(site_url + 'accounting/add_budget', data).done(function(response) {
      response = JSON.parse(response);
...
function update_budget(){
    ...
    $.post(site_url + 'accounting/update_budget', data).done(function(response) {
      response = JSON.parse(response);
...
function delete_budget() {
    ...
    requestGetJSON(site_url + 'accounting/delete_budget/'+$('select[name="budget"]').val()).done(function (response) {
        if(response.success == true){
          appAlert.success(response.message, {duration: 10000});
          ...
          appAlert.warning(response.message, {duration: 10000});
          get_data_budget();
        }
