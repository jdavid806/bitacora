...
(function(){
  "use strict";
    ...
    $("body").on('click', '.new_vendor_requests', function() {
        ...
        newattachment.find('select').select2();
        ...
        newattachment.find('select[id="type[0]"]').attr('id', 'type[' + addMoreVendorsInputKey + ']').val('description').select2();
        ...
        newattachment.find('select[id="subtype[0]"]').attr('id', 'subtype[' + addMoreVendorsInputKey + ']').select2();
        ...
        newattachment.find('select[id="subtype_amount[0]"]').attr('id', 'subtype_amount[' + addMoreVendorsInputKey + ']').select2();
