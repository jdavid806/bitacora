    ...
    <div class="card">
      <table class="tree">
        <tbody>
          ...
          echo html_entity_decode($html_column); 
          ?>
          </tr>
          <tr class="tr_header">
            <td></td>
          ...
          switch ($data_report['display_columns_by']) {
            case 'total_only':
              echo '<td class="th_total_width_auto text-bold">'. app_lang('total') .'</td>';
              break;
            ...
            case 'vendors':
              ...
              echo '<td class="th_total_width_auto text-bold">'. app_lang('not_specified') .'</td>';
              echo '<td class="th_total_width_auto text-bold">'. app_lang('total') .'</td>';
              break;
          ...
          <tr class="treegrid-1000000 parent-node expanded">
            ...
            <?php echo html_entity_decode($html_column); ?>
            <td></td>
          </tr>
          <?php
            $row_index = 0;
            ...
            ?>
            <?php 
              $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['accounts_receivable'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
              $row_index = $data['row_index'];
              echo html_entity_decode($data['html']);
              $total_current_assets += $data['total_amount'];

              $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['cash_and_cash_equivalents'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
              $row_index = $data['row_index'];
              echo html_entity_decode($data['html']);
              $total_current_assets += $data['total_amount'];

              $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['current_assets'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
              $row_index = $data['row_index'];
              echo html_entity_decode($data['html']);
              $total_current_assets += $data['total_amount'];
             ?>
            ...
            <?php 
              $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['fixed_assets'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
              $row_index = $data['row_index'];
              echo html_entity_decode($data['html']);
              $total_long_term_assets += $data['total_amount'];

              $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['non_current_assets'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
              $row_index = $data['row_index'];
              echo html_entity_decode($data['html']);
              $total_long_term_assets += $data['total_amount'];
              ?>
            ...
            <?php 
              ...
              <?php 
                $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['accounts_payable'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
                $row_index = $data['row_index'];
                echo html_entity_decode($data['html']);
                $total_current_liabilities += $data['total_amount'];

                $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['credit_card'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
                $row_index = $data['row_index'];
                echo html_entity_decode($data['html']);
                $total_current_liabilities += $data['total_amount'];

                $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['current_liabilities'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
                $row_index = $data['row_index'];
                echo html_entity_decode($data['html']);
                $total_current_liabilities += $data['total_amount'];
              ?>
              ...
              <?php 
              $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['non_current_liabilities'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
                $row_index = $data['row_index'];
                echo html_entity_decode($data['html']);
              ...
              <?php 
              $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['owner_equity'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
                $row_index = $data['row_index'];
                echo html_entity_decode($data['html']);
