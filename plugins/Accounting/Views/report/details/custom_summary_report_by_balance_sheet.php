    ...
    <table class="tree">
      <tbody>
        ...
        <?php
          ...
          <?php 
            $_index = $row_index;
            $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['accounts_receivable'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $_index, $currency, $data_report['display_columns_by']);
          ...
          <?php 
            ...
            <?php 
              $_index = $row_index;
              $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['accounts_payable'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $_index, $currency, $data_report['display_columns_by']);
              $row_index = $data['row_index'];
              echo html_entity_decode($data['html']);
