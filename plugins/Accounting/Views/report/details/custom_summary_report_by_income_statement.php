  ...
  <div class="card">
    <table class="tree">
      <tbody>
        ...
        <tr>
          <td colspan="14">
            <h4 class="text-center no-margin-top-20 no-margin-left-24"><?php echo app_lang('custom_summary_report'); ?></h4>
          </td>
          <td></td>
        </tr>
        <tr>
        ...
        <?php
          ...
          <?php 
            $_index = $row_index;
            $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['income'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
          ...
          <?php 
          $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['cost_of_sales'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
            $row_index = $data['row_index'];
            echo html_entity_decode($data['html']);
          ...
          <?php 
          $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['other_income'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
            $row_index = $data['row_index'];
            echo html_entity_decode($data['html']);
          ...
          <?php 
            $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['expenses'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
            $row_index = $data['row_index'];
            echo html_entity_decode($data['html']);
          ...
          <?php 
          $data = $Accounting_model->get_html_custom_summary_by_income_statement($data_report['data']['other_expenses'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency, $data_report['display_columns_by']);
            $row_index = $data['row_index'];
            echo html_entity_decode($data['html']);
