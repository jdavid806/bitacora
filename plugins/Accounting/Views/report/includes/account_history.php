              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                      <label for="account" class=""><?php echo app_lang('acc_account'); ?></label>
                      <?php
                          echo form_dropdown("account", $accounts_dropdown, array($account), "class='select2 validate-hidden' id='account'");
                          ?>
                  </div>
                </div>
                <div class="col-md-3">
