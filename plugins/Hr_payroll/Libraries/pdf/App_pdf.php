...
abstract class App_pdf extends TCPDF
{
    ...
    public function __construct()
    {
        ...
        $this->pdf_author = _l('ib_invoice_builder');
        ...
        app_hooks()->do_action('pdf_construct', ['pdf_instance' => $this, 'type' => $this->type()]);
    }
    ...
    {
        return get_pdf_format('A4-PORTRAIT');
    }
    ...
    public function Close()
    {
        ...
        app_hooks()->do_action('pdf_close', ['pdf_instance' => $this, 'type' => $this->type()]);
    ...
    {
        app_hooks()->do_action('pdf_header', ['pdf_instance' => $this, 'type' => $this->type()]);
    }
    ...
    public function Footer()
    {
        ...
        app_hooks()->do_action('pdf_footer', ['pdf_instance' => $this, 'type' => $this->type()]);
    ...
    {
        return app_hooks()->apply_filters($this->type() . '_pdf_build_path', $this->file_path());
    }
