			...
			<div class="card">
				<div class="page-title clearfix">
					...
					<div class="title-button-group">
						<a href="<?php echo site_url('hr_payroll/manage_attendance_timesheet_leaves/'.date('Y-m')); ?>" class=" btn mright5 btn-info pull-right timesheet_leaves_url text-white">
							<span data-feather="upload" class="icon-16" ></span> <?php echo app_lang('hrp_timesheet_leaves'); ?>
						</a>
					</div>
				</div>
				<div class="row ml2 mr5 filter_by">
<!-- date('Y-m', strtotime(get_my_local_time())) -->
					<div class="col-md-2">
				...
				<div class="modal-footer">
					<?php if(hrp_has_permission('hr_payroll_can_create_hrp_attendance') || hrp_has_permission('hr_payroll_can_edit_hrp_attendance')){ ?>
						...
						<button type="button" class="btn btn-info pull-right save_daily_synchronized mleft5 text-white" onclick="daily_synchronized(this); return false;" title="<?php echo app_lang('synchronized_daily_time_title'); ?>"><?php echo app_lang('hrp_daily_time_synchronized'); ?></span><i class="fa fa-question-circle i_tooltip" data-toggle="tooltip" title="" data-original-title="<?php echo app_lang('synchronized_daily_time_title'); ?>"></i></button>
