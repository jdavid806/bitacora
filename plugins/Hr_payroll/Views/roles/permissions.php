<div class="tab-content">
	<?php echo form_open(get_uri("hr_payroll/role_save_permissions"), array("id" => "permissions-form", "class" => "general-form dashed-row", "role" => "form")); ?>
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<ul class="permission-list">
				<?php echo  view('Hr_payroll\Views\includes\hrp_permissions', $permissions); ?>
