...
<div class="row">
	<div class="col-md-6">
		...
		<table border="1"  class="table">
			<tbody>
				<tr>
					<th  class=" thead-dark"><?php echo app_lang('hr_records_earnings_list'); ?></th>
					<th  class=" thead-dark"><?php echo app_lang('hrp_amount'); ?></th>
				</tr>

				<tr class="project-overview">
					<td  width="30%" ><?php echo app_lang('ps_gross_pay'); ?></td>
					<td width="70%"  class="text-left"><?php echo html_entity_decode(isset($payslip_detail) ?  to_decimal_format($payslip_detail['gross_pay'], '') : 0); ?></td>
				</tr>
				<tr class="project-overview">
		...
		<table border="1"  class="table">
			<tbody>
				...
				<tr class="project-overview">
					...
					<td  width="70%" class="text-left"><?php echo html_entity_decode( isset($payslip_detail) ? to_decimal_format($payslip_detail['income_tax_paye']) : ''); ?></td>
				</tr>
				<tr class="project-overview">
