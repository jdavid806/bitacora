		...
		<div class="modal-content">
			...
			<div class="modal-body card-body">
				...
				<div class="table-responsive">
					...
					?>
					<div class="class">
						<?php echo render_select1('role',$roles_value,array('roleid','name'),'staff_add_edit_role',$selected); ?>
					</div>
					...
					<?php if(isset($member)){ 
						...
						<div class="lable-display-name">
							<?php echo render_input1('staff_name', 'hr_hr_staff_name', get_staff_full_name1($member->staffid), '', $staff_attr); ?>
					...
					<div class="class <?php  echo html_entity_decode($display_staff); ?>">
						<?php echo render_select1('staff_id',$staffs,array('staffid',array('firstname', 'lastname')),'hr_hr_staff_name',$staff_selected); ?>
					</div>
