...
<div id="page-content" class="clearfix">
    ...
    <ul id="team-member-view-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs rounded-0" role="tablist">
        ...
        <?php if ($show_general_info) { ?>
            <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("hr_profile/general_info/" . $user_info->id); ?>" data-bs-target="#tab-general-info"> <?php echo app_lang('general_info'); ?></a></li>
        <?php } ?>

        <!-- contract -->
        <?php if ($login_user->id == $user_info->id || is_admin()) { ?>
        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("hr_profile/staff_contracts_info/" . $user_info->id); ?>" data-bs-target="#tab-staff-contracts-info"> <?php echo app_lang('hr_hr_contracts'); ?></a></li>
        <?php } ?>
        
        <!-- dependent person -->
        <?php if ($login_user->id == $user_info->id || is_admin()) { ?>
        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("hr_profile/staff_dependent_info/" . $user_info->id); ?>" data-bs-target="#tab-staff-dependen-person-info"> <?php echo app_lang('hr_dependent_persons'); ?></a></li>
        <?php } ?>

        <!-- Training -->
        <?php if ($login_user->id == $user_info->id || is_admin()) { ?>
        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("hr_profile/staff_training_info/" . $user_info->id); ?>" data-bs-target="#tab-staff-training-info"> <?php echo app_lang('hr_trainings'); ?></a></li>
        <?php } ?>
        ...
        <?php if ($show_job_info) { ?>
            <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_members/job_info/" . $user_info->id); ?>" class="d-none" data-bs-target="#tab-job-info"> <?php echo app_lang('job_info'); ?></a></li>
        <?php } ?>
