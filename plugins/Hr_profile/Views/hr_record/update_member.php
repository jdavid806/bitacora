				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
						...
						<?php if (total_rows(db_prefix() . 'emailtemplates', array('slug' => 'two-factor-authentication', 'active' => 0)) == 0) {?>
							...
							<div class="row">
								<div class="col-md-6">
									<?php echo render_input1('firstname', 'hr_firstname', $value, 'text', $attrs); ?>
								</div>
								<div class="col-md-6">
									<?php echo render_input1('lastname', 'hr_lastname', $lastname, 'text', $attrs); ?>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="sex" class="selectpicker" id="sex" data-width="100%" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
											...
											<option value="<?php echo 'other'; ?>" <?php if (isset($member) && $member->sex == 'other') {echo 'selected';}?>><?php echo app_lang('other'); ?></option>
										</select>
									</div>
								</div>
								...
								<div class="col-md-6">
									...
									echo render_date_input1('birthday', 'hr_hr_birthday', _d($birthday));?>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<?php echo render_input1('phonenumber', 'staff_add_edit_phonenumber', $value); ?>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<?php if (hr_has_permission('hr_profile_can_edit_hr_records') || hr_has_permission('hr_profile_can_create_hr_records')) {?>
										...
										<?php echo render_select1('team_manage', $list_staff, array('staffid', 'full_name'), 'hr_team_manage', $value); ?>
									<?php }?>
									<!--teamanage -->
								</div>
							</div>
							...
							<?php if (is_admin() || hr_has_permission('hr_profile_can_edit_hr_records')) {
								...
								<?php echo render_select1('role_v', $roles_value, array('roleid', 'name'), 'staff_add_edit_role', $selected); ?>
							<?php }?>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6">
											...
											<?php echo render_textarea1('email_signature', 'settings_email_signature', $value, ['data-entities-encode' => 'true']); ?>
										</div>
										<div class="col-md-6">
											<?php
							...
							<div role="tabpanel" class="tab-pane " id="tab_staff_contact">
								...
								<div class="row">
									<div class="col-md-6">
										...
										echo render_input1('current_address', 'hr_current_address', $current_address, 'text');?>
									</div>
									<div class="col-md-6">
										<?php
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										echo render_date_input1('days_for_identity', 'hr_license_date', _d($days_for_identity));?>
									</div>
								</div>
