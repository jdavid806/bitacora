...
require realpath('../../app/Config/Paths.php') ?: FCPATH . 'app/Config/Paths.php';
...
$connect = new PDO("mysql:host=".$database->default['hostname'].";dbname=".$database->default['database'], $database->default['username'],$database->default['password']);

if(isset($_GET["log"]))
{
    
    $query = "
    UPDATE rise_ma_email_logs 
