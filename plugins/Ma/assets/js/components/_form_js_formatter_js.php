...
function do_form_field_restrictions(fId, type) {
  ...
  var admin_url = $('input[name="admin_url"]').val();
   ...
   $( document ).ready(function() {
    $.loadScript('//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js', function(){
       $.loadScript(site_url+'/plugins/Ma/assets/plugins/form-builder/form-builder.min.js', function(){
