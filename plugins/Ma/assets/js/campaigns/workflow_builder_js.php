      ...
      switch (name) {
        case 'flow_start':
            $.post(admin_url + 'ma/get_workflow_node_html', {
                ...
                $("div[node-id="+(editor.nodeId - 1)+"] .select2").select2();
            });
        ...
        case 'action':
          ...
          case 'email':
            $.post(admin_url + 'ma/get_workflow_node_html', {
                ...
                setDatePicker("div[node-id="+(editor.nodeId - 1)+"] [df-exact_time_and_date]");
                setTimePicker("div[node-id="+(editor.nodeId - 1)+"] [df-exact_time]");
                setTimePicker("div[node-id="+(editor.nodeId - 1)+"] [df-exact_time_and_date_2]");
            });
