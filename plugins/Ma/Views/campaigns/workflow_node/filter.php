...
<div class="box" node-id="<?php echo html_entity_decode($nodeId); ?>">
  <div class="form-group">
    ...
    <?php echo render_select('name_of_variable['. $nodeId .']',$tracks, array('id', 'name'),'name_of_variable', '', ['df-name_of_variable' => ''], [], '', '', false); ?>
    <?php $conditions = [ 
    ...
    <?php echo render_input('value_of_variable['. $nodeId .']','value_of_variable', '', 'text', ['df-value_of_variable' => '']); ?>
