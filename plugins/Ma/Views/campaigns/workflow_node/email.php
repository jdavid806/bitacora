...
<div class="box" node-id="<?php echo html_entity_decode($nodeId); ?>">
  <div class="form-group">
    ...
    <div class="radio radio-primary">
      <input type="radio" name="complete_action[<?php echo html_entity_decode($nodeId); ?>]" id="complete_action_right_away[<?php echo html_entity_decode($nodeId); ?>]" value="right_away" checked df-complete_action class="form-check-input">
      <label for="complete_action_right_away[<?php echo html_entity_decode($nodeId); ?>]"><?php echo _l("right_away"); ?></label>
    </div>
    <div class="radio radio-primary">
      <input type="radio" name="complete_action[<?php echo html_entity_decode($nodeId); ?>]" id="complete_action_after[<?php echo html_entity_decode($nodeId); ?>]" value="after" df-complete_action class="form-check-input">
      <label for="complete_action_after[<?php echo html_entity_decode($nodeId); ?>]"><?php echo _l("after"); ?></label>
    </div>
    <div class="radio radio-primary">
      <input type="radio" name="complete_action[<?php echo html_entity_decode($nodeId); ?>]" id="complete_action_exact_time[<?php echo html_entity_decode($nodeId); ?>]" value="exact_time" df-complete_action class="form-check-input">
      <label for="complete_action_exact_time[<?php echo html_entity_decode($nodeId); ?>]"><?php echo _l("exact_time"); ?></label>
    </div>
    <div class="radio radio-primary">
      <input type="radio" name="complete_action[<?php echo html_entity_decode($nodeId); ?>]" id="complete_action_exact_time_and_date[<?php echo html_entity_decode($nodeId); ?>]" value="exact_time_and_date" df-complete_action class="form-check-input">
  ...
  <?php echo render_input('exact_time['.$nodeId.']', 'exact_time', '', 'text', ['df-exact_time' => '']); ?>
  </div>
  <div class="div_complete_action_exact_time_and_date hide">
  <?php echo render_date_input('exact_time_and_date['.$nodeId.']','date', '', ['df-exact_time_and_date' => '']); ?>
  <?php echo render_input('exact_time_and_date_2['.$nodeId.']', 'time', '', 'text', ['df-exact_time_and_date_2' => '']); ?>
