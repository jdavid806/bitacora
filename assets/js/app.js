...
class BuildFilters {
    ...
    prepareSelectionHandler() {
        ...
        if (it.settings.selectionHandler.batchSendMassiveMessageUrl) {
            dropdown += "<li role='presentation'><a class='dropdown-item batch-send-massive-message-btn hide' data-act='ajax-modal' data-action-url='' " + dataPost + " data-title='Enviar mensaje' type='button'>Enviar mensaje</a></li>";
        }
    ...
    updateSelection($selectionMenuWrapper, $itemWrapper, batchIds) {
        ...
        if (batchIds.length) {
            ...
            $selectionMenuWrapper.find(".batch-send-massive-message-btn").removeClass("hide");
            ...
            $selectionMenuWrapper.find(".batch-send-massive-message-btn").addClass("hide");
        ...
        var batchSendMassiveMessageUrl = it.settings.selectionHandler.batchSendMassiveMessageUrl;
        if (batchSendMassiveMessageUrl) {
            var actionUrl = batchSendMassiveMessageUrl;
            $selectionMenuWrapper.find(".batch-send-massive-message-btn").attr("data-action-url", actionUrl + serializedIds);
        }
